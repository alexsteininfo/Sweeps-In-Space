...
setwd("/Users/stein02/Desktop/Plots for the Sweeps/supp_3/")

origins <- read_tsv("data/origins.tsv")
...
a = 1.5
text <- paste("/Users/stein02/Desktop/Plots for the Sweeps/supp_3/figures/","mu", mu, "s", s_m, ".png",sep = "")
